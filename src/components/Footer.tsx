  ...
  const data = {
    ...
    resources: [
      ...
      { id: 2, text: "Sponsors", url: "/soon" },
      {
        ...
        url: "https://find-and-update.company-information.service.gov.uk/company/14834057",
      },
    ],
    links: [
    ...
    socials: [
      {
        id: 3,
        text: "Youtube",
        url: "https://www.youtube.com/@thebithq",
        icon: <SiYoutube className='w-4 h-4 text-zinc-800' />,
      },
      {
        id: 3,
        text: "Instagram",
...

      {
        id: 4,
        text: "Tiktok",
        url: "https://www.tiktok.com/@thebithquk",
        icon: <SiTiktok className='w-4 h-4 text-zinc-800' />,
      },
      {
        id: 2,
      ...
      },
      {
        id: 1,
        text: "Facebook",
        url: "https://www.facebook.com/thebithquk",
