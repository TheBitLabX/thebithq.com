                  ...
                  {events.map((event) => (
                    <article key={event.id}>
                      <Link href="" className="flex space-x-4">
                        ...
                        <div className="relative">
                        <div className="absolute -top-1 right-0 badge badge-accent border-primary py-3">Free</div>

                          <p className="text-[13px] mb-0 text-neutral-500">{event.date}</p>
                          <p className="font-semibold mb-1 text-zinc-700 line-clamp-1">{event.title}</p>
                          <p className="text-xs text-neutral-500 line-clamp-3">{event.desc}</p>
                        </div>
                      </Link>
                    </article>
                  ))}
